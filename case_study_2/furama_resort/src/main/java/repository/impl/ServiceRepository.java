    ...
    public List<House> showHouse() {
        ...
        try {
            ...
            while (resultSet.next()) {
                int id = Integer.parseInt(resultSet.getString("ma_dich_vu"));
                ...
                houseObj.setNumber_of_floors(Integer.parseInt(resultSet.getString("so_tang")));    //vì đây để kiểu int,nếu bên sql null thì bên java sẽ ko có data
